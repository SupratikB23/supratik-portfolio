  ...
  return <section id="projects" className="py-20 bg-section-gradient">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-1 gap-8 max-w-5xl mx-auto">
          ...
          return <Card key={project.title} className={`border-border hover:border-primary transition-all duration-500 hover:shadow-glow-primary animate-fade-in ${project.featured ? 'lg:col-span-2 xl:col-span-1' : ''}`} style={{
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.technologies.map(tech => <Badge key={tech} variant="secondary" className="bg-secondary/50 text-foreground hover:bg-accent hover:text-accent-foreground transition-all duration-300">
                          {tech}
                        </Badge>)}
                    </div>
                  </div>
