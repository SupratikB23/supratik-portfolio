  ...
  return <section id="experience" className="py-20 bg-background">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          {experiences.sort((a, b) => (b.current ? 1 : 0) - (a.current ? 1 : 0)).map((exp, index) => <Card key={`${exp.title}-${exp.organization}`} className="border-border hover:border-primary transition-all duration-500 hover:shadow-glow-primary animate-fade-in" style={{
                ...
                <div className="flex flex-col md:flex-row md:items-start md:justify-between space-y-4 md:space-y-0">
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      ...
                      {exp.current && <Badge className="bg-green-500/20 text-green-400 border-green-500/30">
                          Current
                        </Badge>}
                    </div>
